...
public class Playlist extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnFooter.setPreferredSize(new java.awt.Dimension(522, 50));
        ...
        pnFooterLayout.setHorizontalGroup(
            ...
            .addGroup(pnFooterLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btnPlaylist, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        pnFooterLayout.setVerticalGroup(
            ...
            .addGroup(pnFooterLayout.createSequentialGroup()
                .addGap(14, 14, 14)
                .addComponent(btnPlaylist, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void addFolder(File dir){
        ...
        for (File listOfFile : listOfFiles){
            if (listOfFile.isFile()) {
                ...
                int i = path.lastIndexOf('.');
                if (i > 0){
                    extension = extentionOf(listOfFile);
